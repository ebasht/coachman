...
func migrate(conn *DB, fs embed.FS, dir string) error {
	files := []string{
		...
		dir + "/009_invite_username.sql",
		dir + "/010_hidden_direct_chats.sql",
		dir + "/011_read_receipts.sql",
		dir + "/012_system_group.sql",
		dir + "/013_last_seen.sql",
		dir + "/014_avatar.sql",
		dir + "/015_avatar_cdn.sql",
		dir + "/016_chat_lists.sql",
		dir + "/017_message_event_types.sql",
		dir + "/018_message_client_id.sql",
		dir + "/019_token_version.sql",
		dir + "/020_device_push_tokens.sql",
		dir + "/021_photo_uploads.sql",
		dir + "/022_message_album.sql",
		dir + "/023_message_sequence.sql",
		dir + "/024_native_video_call.sql",
		dir + "/025_message_reply.sql",
		dir + "/026_stories.sql",
		dir + "/027_message_video.sql",
		dir + "/028_chat_avatar.sql",
		dir + "/029_admin_key_backup.sql",
		dir + "/030_login_recovery.sql",
	}
